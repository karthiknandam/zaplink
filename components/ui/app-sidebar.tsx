    ...
    <Sidebar>
      <SidebarContent className="bg-background">
        <SidebarGroup className="p-0!">
          <SidebarGroup className="border-b h-20 border-b-sidebar-border flex justify-center">
      ...
      <SidebarFooter className="px-4 bg-background">
        <Button
          variant={"outline"}
          className="py-7 px-2.5 justify-between items-center rounded-sm cursor-pointer bg-background! outline-0"
        >
          <div className="flex gap-4 items-center">
            <Avatar className="flex-end">
              <AvatarImage src="https://github.com/karthiknandam.png" />
              <AvatarFallback>NVK</AvatarFallback>
            </Avatar>
            <h2 className="text-lg">Karthikeya</h2>
          </div>
          <MoreHorizontalIcon />
        </Button>
      </SidebarFooter>
...
const Logo = () => {
  return (
    <div className="size-10 p-1 text-white dark:text-black dark:bg-secondary-foreground bg-primary rounded-xl">
